    ...
    render() {
      return (
         <ScrollView style = {styles.container}>
            <ImageBackground
              style = {styles.header}
              source={require('./../images/induction_header.png')}>
            </ImageBackground>
            <View>
              <TouchableHighlight
            ...
            <View style={styles.grayData}>
              ...
              <Text style={styles.docsText}>Jueves 31 de agosto de 2018</Text>
            </View>
            ...
            <View style={styles.grayData}>
             ...
             <Text style={styles.docsText}>Edicio 5 planta 2</Text>
            </View>
         </ScrollView>
      );
    }
